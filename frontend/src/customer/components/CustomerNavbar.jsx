              ...
              {isLoggedIn ? (
                <div className="relative" ref={profileMenuRef}>
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-xl bg-dark-300 hover:bg-dark-200 transition-colors duration-300 border border-dark-100"
                  >
                  ...
                  {/* Profile Dropdown */}
                  <div
                    className={`absolute right-0 mt-2 w-56 bg-dark-300 rounded-xl border border-dark-100 shadow-2xl overflow-hidden transition-all duration-300 origin-top-right ${
                      showProfileMenu
