...
import {
  ...
  Camera, Edit2, Save, X, Clock, Shield, Dumbbell
} from "lucide-react";
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          {isEditing ? (
            <input
              ...
              className="text-2xl font-bold text-white bg-transparent border-b-2 border-orange-500 text-center pb-1 focus:outline-none w-64 mb-2"
            />
          ) : (
        ...
        <div className="space-y-3">
          ...
          <div className="bg-[#111] rounded-2xl p-4 border border-gray-800/50 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white font-medium truncate">{memberProfile.mobile || "Not set"}</p>
            </div>
