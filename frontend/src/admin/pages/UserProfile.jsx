...
const UserProfile = () => {
  ...
  if (!member) {
    return (
      <div className="flex flex-col items-center justify-center py-20 min-h-screen">
        ...
        <Link to="/admin/list" className="btn-primary mt-4">
          Back to List
        </Link>
      </div>
    );
        ...
        <div className="card-dark p-6 md:p-8 text-center border-2 border-red-500/30">
          ...
          <div className="border-t border-gray-700 pt-6 mt-6">
            <p className="text-gray-500 mb-4">
              This membership has been cancelled. To reactivate, click below.
            </p>
            <Link
  ...
  return (
    <div className="max-w-4xl mx-auto pt-6 pb-12 px-4">
      ...
      <div className="card-dark p-6 md:p-8 mb-6">
        <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
          <div className="relative">
            ...
            />
            <span
              className={`absolute bottom-2 right-2 w-5 h-5 rounded-full border-2 border-dark-200 ${
                days > 0 ? "bg-green-500" : "bg-red-500"
              }`}
            ></span>
          </div>
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              <Link
                to={`/admin/update/${member._id}`}
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-yellow-500/20 text-yellow-400 hover:bg-yellow-500/30"
              >
          ...
          <div
            className={`p-6 rounded-2xl text-center min-w-[140px] ${
              days > 30
              ...
              <>
                <p
                  className={`text-4xl font-bold ${
                    days > 30 ? "text-green-400" : "text-yellow-400"
                  }`}
                >
                  {days}
                </p>
      ...
      <div className="card-dark p-6 my-2">
        <p className="text-gray-400 font-extrabold py-1 leading-relaxed">
          D.O.B :
        </p>
