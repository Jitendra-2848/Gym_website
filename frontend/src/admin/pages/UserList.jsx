                  ...
                  >
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-2 text-sm">
                        <span className="px-3 flex py-1 rounded-full text-xs font-medium bg-purple-500/20 text-purple-300">
                          {durationMonths !== null
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        {/* 3 DOT MENU (same logic, only smaller size) */}
                        <div className="relative">
                          <button
                            className="p-1.5 rounded-lg bg-dark-200 text-gray-300 hover:bg-dark-100"
                            onClick={() =>
                              setOpenMenuId(
                          ...
                          {openMenuId === member.id && (
                            <div className="absolute right-0 mt-2 w-28 rounded-lg bg-dark-300 border border-dark-100 shadow-xl z-20">
                              <Link
                                to={`/admin/profile/${member.id}`}
                                className="block px-3 py-1.5 text-xs text-blue-400 hover:bg-dark-200 rounded-t-lg"
                              ...
                              <Link
                                to={`/admin/update/${member.id}`}
                                className="block px-3 py-1.5 text-xs text-yellow-400 hover:bg-dark-200"
                                onClick={() => setOpenMenuId(null)}
                              >
                                Edit
                              </Link>
                              <button
                                className="block w-full text-left px-3 py-1.5 text-xs text-red-400 hover:bg-dark-200 rounded-b-lg"
                                onClick={() => setOpenMenuId(null)}
                              >
                                Delete
                              </button>
